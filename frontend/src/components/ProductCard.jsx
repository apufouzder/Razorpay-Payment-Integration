...
export default function ProductCard() {
    ...
    return (
        <Card className="mt-6 w-96 bg-cyan-900 text-white">
            {/* CardHeader */}
            <CardHeader color="" className="relative h-96 bg-gray-700">
                {/* Image  */}
                <img
            ...
            <CardBody>
                ...
                <Typography>
                    ₹100 <span className="line-through">₹250</span>
                </Typography>
            </CardBody>
            ...
            <CardFooter className="pt-0">
                {/* Buy Now Button  */}
                <Button onClick={handlePayment} className="w-full bg-blue-500">Buy Now</Button>
                <Toaster />
            </CardFooter>
        </Card>
    );
